            ...
            if (notifykey != "newShip") {
              ...
              return (
                ...
                <OverlayTrigger placement={'top'} overlay={
                  <Tooltip>
                    <Button bsStyle="success" bsSize="xsmall" block><FontAwesome name="comment" style={{marginRight: '5px'}}/>提醒此船</Button>
                    <Button bsStyle="default" bsSize="xsmall" block><FontAwesome name="commenting" style={{marginRight: '5px'}}/>不提醒此船</Button>
                    <small>点击可切换状态</small>
                  </Tooltip>
                }>
                  <Col xs={4} sm={colSm} md={colMd}>
                    <div className={color}>
                      <span className="ship-name" onClick={() => {this.changeNotify(notifykey)}}>
                         {notifyvalue == 1 ? <FontAwesome name="comment" style={{marginRight: '5px'}}/> : <FontAwesome name="commenting" style={{marginRight: '5px'}}/>}{$ships[notifykey].api_name}
                      </span>
